<template lang="">
  <div class="text-gray-900 text-sm">
    <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
      <div class="flex items-center space-x-4">
        ...
        <div class="relative ">
          <input type="text" class="rounded bg-gray-700 text-sm placeholder-white px-3 py-1"
      ...
      <div class="flex items-center space-x-4 text-white">
        <a href="#" class="relative hover:text-grey-400">
        ...
        <a href="#" class="flex items-center hover:text-grey-400">
          <svg class="w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
        ...
        <a href="#" class="flex items-center hover:text-grey-400">
          <img alt="@pabloandi" src="https://avatars0.githubusercontent.com/u/4078258?s=60&amp;v=4" class="w-5 h-5 rounded-full" width="20" height="20">
          <svg class="w-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
        </a>
      </div>
    </nav>
    ...
    <div class="repo-stats flex items-center justify-between px-8 py-4">
      ...
      <div class="flex space-x-2">
        ...
        <div class="flex text-xss">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1 hover:bg-gray-200">
        ...
        <div class="flex text-xss">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
            <svg class="fill-current text-gray-600 w-4"  viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25zm0 2.445L6.615 5.5a.75.75 0 01-.564.41l-3.097.45 2.24 2.184a.75.75 0 01.216.664l-.528 3.084 2.769-1.456a.75.75 0 01.698 0l2.77 1.456-.53-3.084a.75.75 0 01.216-.664l2.24-2.183-3.096-.45a.75.75 0 01-.564-.41L8 2.694v.001z"></path></svg>
            <div>Star</div>
            <svg class="w-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
          </button>
          <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">25.3k</a>
        </div>

        <div class="flex text-xss">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
            <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"></path></svg>
            <div>Fork</div>
            <svg class="w-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
          </button>
          <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">25.3k</a>
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      ...
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-red-500 px-4 pb-3">
          <svg class="w-4 fill-current text-gray-600" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M4.72 3.22a.75.75 0 011.06 1.06L2.06 8l3.72 3.72a.75.75 0 11-1.06 1.06L.47 8.53a.75.75 0 010-1.06l4.25-4.25zm6.56 0a.75.75 0 10-1.06 1.06L13.94 8l-3.72 3.72a.75.75 0 101.06 1.06l4.25-4.25a.75.75 0 000-1.06l-4.25-4.25z"></path></svg>
          <span class="ml-2">Code</span>
        </a>
      </li>

      <li>
        <a href="#" class="flex items-center px-4 pb-3 border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150">
          <svg class="w-4 fill-current text-gray-600" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M8 1.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13zM0 8a8 8 0 1116 0A8 8 0 010 8zm9 3a1 1 0 11-2 0 1 1 0 012 0zm-.25-6.25a.75.75 0 00-1.5 0v3.5a.75.75 0 001.5 0v-3.5z"></path></svg>
      ...
      <li>
        <a href="#" class="flex items-center px-4 pb-3 border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150">
          <svg class="w-4 fill-current text-gray-600" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0zM8 0a8 8 0 100 16A8 8 0 008 0zM6.379 5.227A.25.25 0 006 5.442v5.117a.25.25 0 00.379.214l4.264-2.559a.25.25 0 000-.428L6.379 5.227z"></path></svg>
      ...
      <div class="branch-navigation flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <button class="border border-gray-400 rounded-md px-4 py-1 hover:bg-gray-200 flex items-center space-x-2">
            <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"></path></svg>
            <div class="font-semibold">master</div>
            <svg class="w-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
          </button>

          <a href="#" class="flex items-center space-x-2 px-3 py-1 group">
            <svg class="fill-current text-gray-600 group-hover:text-blue-600 w-4" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"></path></svg>
          ...
          <a href="#" class="flex items-center space-x-2 px-3 py-1 group">
            <svg class="fill-current text-gray-600 group-hover:text-blue-600 w-4" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M2.5 7.775V2.75a.25.25 0 01.25-.25h5.025a.25.25 0 01.177.073l6.25 6.25a.25.25 0 010 .354l-5.025 5.025a.25.25 0 01-.354 0l-6.25-6.25a.25.25 0 01-.073-.177zm-1.5 0V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 010 2.474l-5.026 5.026a1.75 1.75 0 01-2.474 0l-6.25-6.25A1.75 1.75 0 011 7.775zM6 5a1 1 0 100 2 1 1 0 000-2z"></path></svg>
            <span class="group-hover:text-blue-600 text-gray-700">
        ...
        <div class="flex items-center space-x-2">
          ...
          <button class="border border-gray-400 rounded-md text-black bg-gray-100 hover:bg-gray-200 px-4 py-1 flex items-center space-x-2">
            <div>Go to file</div>
          </button>
          ...
          <button class="border border-gray-400 rounded-md text-white bg-green-600 hover:bg-green-700 px-4 py-1 flex items-center space-x-2">
            <svg class="fill-current w-4" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M7.47 10.78a.75.75 0 001.06 0l3.75-3.75a.75.75 0 00-1.06-1.06L8.75 8.44V1.75a.75.75 0 00-1.5 0v6.69L4.78 5.97a.75.75 0 00-1.06 1.06l3.75 3.75zM3.75 13a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5h-8.5z"></path></svg>
            <div>Code</div>
            <svg class="w-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
          </button>
      ...
      <!-- end commits-container -->
       <div class="file-explorer rounded-md rounded-t-none border border-gray-400 text-gray-700 divide-y divide-gray-400">
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Update issues template</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Remove stale test</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Add empty .npmignore so dist files are distributed with releases</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Use `process.env.JEST_WORKER_ID`</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Prevent source maps from being generated</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Only wrap with variants if rules don't already contain any variants</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">4 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Generate responsive variants for container by default</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">4 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Convert new stuff to use ES6 modules</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">3 years ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Updated CLI init commend</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Disable lint rule for TODO comments</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600 truncate hidden lg:block">Add new `plugin` and `plugin.withOptions` functions for creating plugins</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Add alt attribute to logo</a></div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Undo accidental changes to CDN build process</a></div>
            <div class="w-4/12 lg:w-2/12 text-right">7 months ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600">Move CSS files to root for easier imports</a></div>
    ...
    <div class="sidebar w-1/4">
      ...
      <div class="used-by border-t border-gray-400 mt-6 pt-6">
        ...
        <div class="mt-4">
          <a href="#" class="flex items-center -space-x-2">
            <img class="w-8 border-2 border-white rounded-full" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <img class="w-8 border-2 border-white rounded-full -ml-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4">
            <span class="text-xs text-blue-600 font-semibold hover:underline" style="margin-left:0.5em">+ 58,367</span>
      ...
      <div class="contributors border-t border-gray-400 mt-6 pt-6">
        ...
        <div class="flex items-center flex-wrap mt-2">
          <a href="#"><img class="w-8 rounded-full mr-2 mt-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4"></a>
          <a href="#"><img class="w-8 rounded-full mr-2 mt-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4"></a>
          <a href="#"><img class="w-8 rounded-full mr-2 mt-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4"></a>
          <a href="#"><img class="w-8 rounded-full mr-2 mt-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4"></a>
          <a href="#"><img class="w-8 rounded-full mr-2 mt-2" alt="@gn00678465" src="https://avatars1.githubusercontent.com/u/37042723?s=88&amp;u=0462f51ea61343eac00e5952a0268376da7cc0fb&amp;v=4"></a>
      ...
      <div class="languages border-t border-gray-400 mt-6 pt-6">
        ...
        <ul class="mt-2 flex space-x-8 items-center text-xs">
          ...
          <li class="flex items-center">
            <span class="w-2 h-2 rounded-full bg-yellow-700"></span>
            <span class="ml-5">
  ...
  <footer class="container mx-auto text-xs border-t border-gray-400 px-10 flex items-center justify-between">
